function [key_points,coef,trajectory] = getTraMode(path, vel)
...
for i = 1 : point_num
    ...
    for t = key_points(1, i) : key_points(1, i + 1)
        Tmp = t - key_points(1, i);
        traX = sum(coef(1:4, i) .* [Tmp^3; Tmp^2; Tmp; 1]);
        traY = sum(coef(5:8, i) .* [Tmp^3; Tmp^2; Tmp; 1]);
        traZ = sum(coef(9:12, i) .* [Tmp^3; Tmp^2; Tmp; 1]);
