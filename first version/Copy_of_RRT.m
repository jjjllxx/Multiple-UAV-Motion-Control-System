...
% speed=3;
% %calculate coefficient for trajectory
% [inflection,coefficient,trajectory]=drawTrajectory(path);

% [seg_path,seg_time,acc] = setVelocity(path,speed);
% total_time=sum(seg_time);total_path=sum(seg_path);
