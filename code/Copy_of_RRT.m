...
for i=1:UAV_num
    start(i,1)=i*rand;goal(i,1)=i*rand+(world_size-UAV_num);
    start(i,2)=i*rand;goal(i,2)=i*rand+(world_size-UAV_num);
    start(i,3)=i*rand;goal(i,3)=i*rand+(world_size-UAV_num);
end
% generate RRT path
for i=1:UAV_num
